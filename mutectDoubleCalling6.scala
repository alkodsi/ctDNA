#!/usr/bin/env anduril
//$OPT --threads 15
//$OPT -d /mnt/storage2/work/amjad/ctdna/result_mutectDoubleCalling6
...
object ctdna{
  ...
  val list3 = INPUT(path = "/mnt/storage2/work/amjad/ctdna/result_ctdnaAlignment6/bamCorrectedOutCSV/out.csv")
  ...
  val list = CSVDplyr(csv1 = list1, 
       ...
       function2 = """filter(grepl("CHIC_51", Key) | grepl("CHIC_71", Key) | grepl("CHIC_143", Key))""",
       function3 = """bind_rows(csv3)""")
